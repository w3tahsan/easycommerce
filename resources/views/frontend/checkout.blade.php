                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="mobile" class="form-control" value="{{ Auth::guard('customerlogin')->user()->phone }}">
                            </div>
                        </div>
            ...
            <div class="col-12 col-lg-4 col-md-12">
                ...
                <div class="mb-4">
                    <div class="form-group">
                        ...
                        <ul class="no-ul-list">
                            <li>
                                <input id="c1" class="radio-custom charge" data-subtotal="{{ $total_after_discount }}" name="charge" type="radio" value="70">
                                <label for="c1" class="radio-custom-label">Inside City</label>
                            </li>
                            <li>
                                <input id="c2" class="radio-custom charge" data-subtotal="{{ $total_after_discount }}" name="charge" type="radio" value="100">
                ...
                <div class="card mb-4 gray">
                    ...
                    <ul class="list-group list-group-sm list-group-flush-y list-group-flush-x">
                        ...
                        <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                        <span>Total</span> <span class="ml-auto text-dark ft-medium">&#2547; <span id="grand_total">{{ $total_after_discount }}</span></span>
                        </li>
                    </ul>
                    </div>
                </div>
