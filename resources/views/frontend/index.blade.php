                    ...
                    <div class="killore--block-link-content">
                        <ul>
                            @foreach ($categories as $category)
                                <li><a href="javascript:void(0);"><img width="20" src="{{ asset('uploads/category') }}/{{ $category->category_image }}" alt=""> &nbsp;{{ $category->category_name }}</a></li>
                            @endforeach
                    ...
                    <div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
                        <div class="text-left">
                            <div class="text-left">
                                ...
                                <h5 class="fs-md mb-0 lh-1 mb-1"><a href="{{ route('product.details', $product->slug) }}">
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                ...
                <div class="ftr-content">
                    @foreach ($top_selling_product as $top)
                    <!-- Single Item -->
                    <div class="product_grid row">
                        <div class="col-xl-4 col-lg-5 col-md-5 col-4">
                            <div class="shop_thumb position-relative">
                                <a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img class="card-img-top" src="{{ asset('uploads/product/preview') }}/{{ $top->rel_to_product->preview }}" alt="..."></a>
                            </div>
                        </div>
                        <div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
                            <div class="text-left mfliud">
                                <div class="elso_titl"><span class="small">{{ $top->rel_to_product->rel_to_cat->category_name }}</span></div>
                                <h5 class="fs-md mb-0 lh-1 mb-1 ft-medium">
                                    <a href="shop-single-v1.html">{{ $top->rel_to_product->product_name }}</a>
                                </h5>

                                    @php
                                        $total_review = App\Models\OrderProduct::where('product_id', $top->product_id)->whereNotNull('review')->count();
                                        $total_star = App\Models\OrderProduct::where('product_id', $top->product_id)->whereNotNull('review')->sum('star');
                                        if($total_review == 0){
                                            $avg = 0;
                                        }
                                        else{
                                ...
                                <div class="elis_rty"><span class="ft-bold text-dark fs-sm">&#2547; {{ $top->rel_to_product->after_discount }}</span></div>
                            </div>
                        </div>
                    </div>
                    @endforeach
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                ...
                <div class="ftr-content">
                    ...
                    <div class="product_grid row">
                        <div class="col-xl-4 col-lg-5 col-md-5 col-4">
                            <div class="shop_thumb position-relative">
                                <a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img class="card-img-top" src="{{ asset('uploads/product/preview')}}/{{ $recentproduct->preview }}" alt="..."></a>
                            </div>
                        </div>
                        <div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
                            <div class="text-left mfliud">
                                <div class="elso_titl"><span class="small">{{ $recentproduct->rel_to_cat->category_name }}</span></div>
                                <h5 class="fs-md mb-0 lh-1 mb-1 ft-medium"><a href="shop-single-v1.html">{{ $recentproduct->product_name }}</a></h5>
                                <div class="star-rating align-items-center d-flex justify-content-left mb-2 p-0">
                                    <i class="fas fa-star filled"></i>
                                    <i class="fas fa-star filled"></i>
                                    <i class="fas fa-star filled"></i>
                                ...
                                <div class="elis_rty"><span class="ft-bold text-dark fs-sm">&#2547;{{ $recentproduct->after_discount }}</span></div>
                            </div>
                        </div>
                    </div>
                    @endforeach
