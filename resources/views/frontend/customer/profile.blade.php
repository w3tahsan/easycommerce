                    ...
                    <form class="row m-0" action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="Dhananjay" / value="{{ Auth::guard('customerlogin')->user()->name }}">
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="email" class="form-control" placeholder="dhananjay7@gmail.com" / value="{{ Auth::guard('customerlogin')->user()->email }}">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="number" name="phone" class="form-control" placeholder="Phone" / value="{{ Auth::guard('customerlogin')->user()->phone }}">
                            </div>
                        </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="country" class="form-control" placeholder="Country" / value="{{ Auth::guard('customerlogin')->user()->country }}">
                            </div>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label class="small text-dark ft-medium">Address</label>
                                <input type="text" name="address" class="form-control" placeholder="Address" / value="{{ Auth::guard('customerlogin')->user()->address }}">
                            </div>
                        </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <button type="submnit" class="btn btn-dark">Save Changes</button>
                            </div>
                        </div>
