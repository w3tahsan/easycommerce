									...
									<div class="headd-sty-02 ml-3">
										<form class="bg-white rounded-md border-bold">
											<div class="input-group">
												<input type="text" class="search_input form-control custom-height b-0" placeholder="Search for products..." / value="{{ @$_GET['q'] }}">
												<div class="input-group-append">
													<div class="input-group-text"><button class="btn search_btn bg-white text-danger custom-height rounded px-3" type="button"><i class="fas fa-search"></i></button></div>
												</div>
											</div>
										</form>
									</div>
